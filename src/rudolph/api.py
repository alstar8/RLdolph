            ...
            with torch.no_grad():
                ...
                for idx in iter_range:
                    ...
                    if image_prompts is not None and idx in prompts_idx:
                        ...
                        print('LOGITS3 shape: ',logits.shape)    
                        logits /= temperature
                        filtered_logits = transformers.top_k_top_p_filtering(logits, top_k=top_k, top_p=top_p)
                        print('LOGITS4 shape: ',filtered_logits.shape)
    ...
    def zs_clf(self, pil_img, classes, bs=10, r_template=None, l_template=None, seed=None,
        ...
        with torch.no_grad():
            ...
            for indexes in more_itertools.chunked(range(len(classes)), bs):
                ...
                print('Indexes: ',indexes,chunk_bs)
                ...
                print('Output shapes: ',r_text_logits[:, :, :].shape,input_ids[:, -(self.r_text_seq_length - 1):].shape)
